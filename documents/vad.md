...
| `SILERO_STUCK_MAX_PROB` | 0.01 | `BleSpeechPolicy.kt` |
| `BLE_RESCUE_PEAK_THRESHOLD` | 0.08 | `BleSpeechPolicy.kt` |
| `BLE_RESCUE_RMS_THRESHOLD` | 0.015 | `BleSpeechPolicy.kt` |
| `BLE_RESCUE_BAND_RATIO_THRESHOLD` | 0.48 | `BleSpeechPolicy.kt` |
...
- `BLE_RESCUE_*`: Silero が壊れている場合や、Silero が弱音声を取りこぼした場合でも、FFT 比率と BLE PCM の振幅/帯域集中度が十分なら Groq 送信を継続する
