...
確認内容だけを電話のTTSでも読み上げる。シングルタップで Terminal Harbor へ送信、
ダブルタップで取り消し。モード切替は発話の先頭を
...
同じ要約は電話のTTSでも一度だけ読み上げ、Claude Code / Codex の作業内容と確認事項を
グラスを見ずに把握できる。新しい作業が始まった後は、同じ文面の要約でも再度読み上げる。
