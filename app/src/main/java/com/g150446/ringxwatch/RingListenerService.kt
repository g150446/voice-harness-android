...
class RingListenerService : Service() {
    ...
    companion object {
        const val ACTION_PLAY = "com.g150446.ringxwatch.ACTION_PLAY"
        const val ACTION_PAUSE = "com.g150446.ringxwatch.ACTION_PAUSE"
        const val ACTION_TOGGLE_PLAYBACK = "com.g150446.ringxwatch.ACTION_TOGGLE_PLAYBACK"
    ...
    private fun setupMediaSession() {
        mediaSession = MediaSessionCompat(this, "RingXwatchSession").apply {
            setFlags(
            ...
            setMetadata(
                MediaMetadataCompat.Builder()
                    ...
                    .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, "RingXwatch")
                    ...
                    .putString(MediaMetadataCompat.METADATA_KEY_ALBUM_ARTIST, "RingXwatch")
